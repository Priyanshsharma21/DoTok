...
<div className='w-full dark:bg-slate-800'>
        <div className='flex-col gap-6 md:gap-10 mb-4 mt-5 dark:bg-slate-800 bg-white w-full'>
            ...
            <p className='mt-10 p-2 text-2xl font-semibold text-gray-600 dark:text-slate-400'>
                ...
                <p className='mt-1 p-2 text-2xl font-semibold text-gray- dark:text-slate-400'>
                You can like, share & comment on videos after login. <br />
                Everything is free here and Your data is 100% safe.
                </p>

                <p className='mt-1 p-2 text-2xl font-semibold text-gray-600 dark:text-slate-400'>
                ...
                You can watch videos from different categories like <p className='text-red-400 dark:text-slate-400'>#AddValueToLife</p>
